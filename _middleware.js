// /_middleware.js
// This middleware will run for all files in the root directory
...
/**
 * Middleware to protect specific files (like b.html) at the root level.
 */
export async function onRequest(context) {
    const { request, env, next } = context;
    const url = new URL(request.url);
    const pathname = url.pathname;
    const functionName = "[root-middleware]";
    
    // Only apply protection to b.html specifically
    // This ensures the middleware only runs for this specific file
    if (pathname === "/b.html") {
        console.log(`${functionName} Protecting access to b.html`);
